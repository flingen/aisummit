      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col gap-12">
          <div className="flex flex-col items-center text-center border-b border-white/10 pb-12">
            ...
            />
            <span className="font-satoshi font-bold text-white text-2xl block mb-2">BUILD AI SUMMIT 1.0</span>
            <span className="text-purple-light text-base font-medium mb-4">
              Powered by{' '}
              <a
            ...
            <p className="text-text-light max-w-2xl leading-relaxed text-sm">
              ...
              {' '}is committed to advancing the adoption and integration of emerging
              technologies such as AI and stablecoins across Africa. We believe that collaboration
              among stakeholders is essential for creating a thriving ecosystem that benefits all
              Africans.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-16 border-b border-white/10 pb-12">
            <div className="flex flex-col sm:flex-row gap-6">
              <a
                href="mailto:ai@afristablecoin.org"
                className="flex items-center gap-3 text-text-grey hover:text-purple-light transition-colors group"
              >
                <div className="w-10 h-10 rounded-xl bg-white/5 group-hover:bg-volt/20 flex items-center justify-center transition-colors">
                  <Mail className="w-5 h-5" />
                </div>
                <span>ai@afristablecoin.org</span>
              </a>
              <a
                ...
                {footerLinks.socials.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-text-grey hover:text-white hover:bg-volt transition-all duration-300"
                    >
                      <IconComponent />
                    </a>
                  );
          ...
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <div className="flex gap-6">
              <a
                href="https://docs.google.com/document/d/1QDj1mBvRhNjmf7yIKStuKEcwv4OIVXBzyAT7m_QpM5U/edit?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
                className="text-text-grey hover:text-purple-light text-sm transition-colors"
              >
                Privacy Policy
              </a>
              <a
                href="https://docs.google.com/document/d/1XlvY_OMKdpjsw2V4TeDBuJUG8U146CPKT5bl70bFi0g/edit?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
                className="text-text-grey hover:text-purple-light text-sm transition-colors"
              >
