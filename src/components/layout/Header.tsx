...
const navLinks: NavLink[] = [
  ...
  { label: 'Agenda', to: '/agenda', type: 'internal' },
  {
    ...
    to: 'https://drive.google.com/drive/folders/1piAb3McIIhbNl3cmNMs-CDDWDxQ4lDAy?usp=sharing',
    type: 'external',
  },
  {
    label: 'Gallery',
  ...
  },
  {
    ...
    to: 'https://forms.gle/ANkQJexAc7Bx3wWB7',
    type: 'external',
    highlight: true,
  },
];
...
export function Header() {
  ...
  const linkClassesDesktop =
    'text-white/80 hover:text-purple-light text-sm font-medium transition-colors relative group';
  const linkClassesMobile =
    'text-white/80 hover:text-purple-light text-base font-medium transition-colors';
    ...
    if (link.highlight) {
      ...
      return (
        <a
          ...
          className={highlightClassesDesktop}
        >
          <Sparkles className="w-3.5 h-3.5" />
          {link.label}
        </a>
