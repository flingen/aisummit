  ...
  return (
    <section className="py-20 md:py-24 section-dark relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-14 relative z-10">
        <SectionHeading
          eyebrow="trusted_by_industry_leaders"
          title="Brands at Our Other Events"
          subtitle="Founders, operators and policy voices from these companies have graced the stage at Africa Stablecoin Network events. Build AI Summit is the next chapter. Be on this wall next year."
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 relative z-10">
        <div className="text-center">
          <p className="text-text-grey text-sm">
            <span className="text-volt font-semibold">{brands.length}+</span> brands ·{' '}
            <span className="text-signal font-semibold">One network</span> · One movement
